        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline dark:text-white">Registrar</a>
                        @endif
                    @endauth
                </div>
            @endif
            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-4">
                ...
                <div class="flex justify-center text-primary">
                    <h1>Centro ecuestre Caballos para disfrutar</h1>                    
                </div>
                <div class="flex justify-center text-success">
                    <h3>Realiza y gestiona tus reservas de clases de hípica en nuestro centro. Pero primero registrate</h3>
                </div>
                <div class="flex justify-center text-secondary">
                    <h4>reservas@caballosparadisfrutar.com</h4>
                </div>
